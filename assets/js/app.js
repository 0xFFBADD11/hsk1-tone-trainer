...
import { HSK1 } from '../data/hsk1.js?v=20260630u'
import { HSK1_EXAMPLES } from '../data/hsk1-examples.js?v=20260630u'
import { el, clear } from './dom.js?v=20260630u'
import { speak, speechSupported } from './speech.js?v=20260630u'
import { recordPitchContour, microphoneSupported, primeAudio } from './pitch.js?v=20260630u'
import { scoreWord, TONE_NAMES } from './tone.js?v=20260630u'
import { createQuiz } from './quiz.js?v=20260630u'
import { toWhisperInput } from './audio.js?v=20260630u'
import { pronounceSupported, pronounceReady, loadModel, transcribe, cleanHeard, pronunciationCloseness } from './pronounce.js?v=20260630u'
...
const BUILD = '20260630u · whisper-small-cdn'
